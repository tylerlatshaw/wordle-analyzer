export default function LoadingInput() {
    ...
    const row = <>
        <div className="w-16 h-16 m-2 border-2 border-gray-400 rounded-sm animate-pulse bg-gray-300">
    ...
    return <>
        ...
        <div className="flex flex-col items-center justify-center">
            <div className="flex flex-row items-center">
                {row}
                <div className="w-16 h-16 m-2 border-2 border-gray-400 rounded-sm animate-pulse bg-[#1975d2]">
                    <div className="w-full h-full m-0 p-0"></div>
                </div>
            </div>
            <div className="flex flex-row items-center">
